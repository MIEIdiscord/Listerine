  ...
  def handle_event({:GUILD_MEMBER_ADD, member}, state) do
    embed = %{
      ...
      description:
        ...
        Temos também o nosso bot Sysadmin que permite que te juntes às salas das cadeiras com o comando `$study CADEIRA` ou, se preferires, podes-te juntar a todas as cadeiras de um ano com o comando `$study 1ano`"
    }

defmodule Listerine.Consumer do
  ...
  def handle_event({:GUILD_MEMBER_ADD, member}, state) do
    ...
    embed = %{
      ...
      description: "O nosso objetivo é facilitar a vossa passagem neste curso, através de um server com todas as cadeiras, materiais e conteúdos para que possam estar sempre a par do que acontece em cada cadeira.
